...
internal static class OvertimeFeedEndpoints
{
    public static void MapOvertimeFeedEndpoints(this WebApplication app)
    {
        ...
        {
            var denied = ObsSessionAccess.DeniedResult(sessionAccess.RequireObs(context.Request, "overtime", "default", "read"));
        ...
        {
            var denied = ObsSessionAccess.DeniedResult(sessionAccess.RequireObs(context.Request, "overtime", "default", "control"));
            if (denied is not null) return denied;
